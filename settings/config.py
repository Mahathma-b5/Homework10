...
class Settings(BaseSettings):
    # General settings
    max_login_attempts: int = Field(default=3, description="Maximum allowed login attempts before locking the account")
    ...
    # PostgreSQL specific configurations (optional if you want to configure them separately)
